...
const SWAGGER_TITLE = 'ParkLink Parking Service API';
const SWAGGER_DESCRIPTION = 'Servicio de gestión y búsqueda de espacios de estacionamiento de ParkLink.';
const SWAGGER_TAGS = ['Parking Spaces', 'Health'];
