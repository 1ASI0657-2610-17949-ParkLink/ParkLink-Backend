...
const SWAGGER_TITLE = 'ParkLink Auth Service API';
const SWAGGER_DESCRIPTION = 'Servicio de autenticación, registro, login y emisión de JWT para ParkLink.';
const SWAGGER_TAGS = ['Auth', 'Health'];
