...
const SWAGGER_TITLE = 'ParkLink Notification Service API';
const SWAGGER_DESCRIPTION = 'Servicio de notificaciones internas de ParkLink.';
const SWAGGER_TAGS = ['Notifications', 'Health'];
