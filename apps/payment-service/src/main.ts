...
const SWAGGER_TITLE = 'ParkLink Payment Service API';
const SWAGGER_DESCRIPTION = 'Servicio de pagos simulados y recibos de ParkLink.';
const SWAGGER_TAGS = ['Payments', 'Health'];
