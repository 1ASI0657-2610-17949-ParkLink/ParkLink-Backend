...
const SWAGGER_TITLE = 'ParkLink Maps Service API';
const SWAGGER_DESCRIPTION = 'Servicio de integración con Google Maps API para geocoding, reverse geocoding y distancias.';
const SWAGGER_TAGS = ['Maps', 'Health'];
const IS_BEARER_AUTH_ENABLED = false;
